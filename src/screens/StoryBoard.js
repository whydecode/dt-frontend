          ...
          <Draggable cancel="strong" onDrag={(e, ui) => handleDrag(0, e, ui)}>
            <div>
              ...
              <div className="handle">
                <div
                  className={
                    desClose[0] ? "taskDescription desClose" : "taskDescription"
                  }
                >
                  <p>
          ...
          <Draggable cancel="strong" onDrag={(e, ui) => handleDrag(1, e, ui)}>
            <div>
              ...
              <div className="handle">
                <div
                  className={
                    desClose[1] ? "taskDescription desClose" : "taskDescription"
                  }
                >
                  <p>
                    <span>Description: </span>
          ...
          <Draggable cancel="strong" onDrag={(e, ui) => handleDrag(2, e, ui)}>
            <div>
              ...
              <div className="handle">
                <div
                  className={
                    desClose[2] ? "taskDescription desClose" : "taskDescription"
                  }
                >
                  <p>
                    <span>Description: </span>
                  ...
                  <div className="structureEnd">
                    ...
                    <div className="structureBottom">
                      ...
                      <div class="file-input">
                        <label for="uploadButton" class="file-label">
                          Choose File
                        </label>
                        <input
                          type="file"
                          ...
                          class="hidden-input"
                        />
                        <label for="uploadButton" class="upload-button">
                          Upload
                        </label>
                      </div>
                    </div>
          ...
          <Draggable cancel="strong" onDrag={(e, ui) => handleDrag(3, e, ui)}>
            <div>
              ...
              <div className="handle">
                <div
                  className={
                    desClose[3] ? "taskDescription desClose" : "taskDescription"
                  }
                >
                  <p>
                    <span>Description: </span>
                ...
                <div className="taskBody">fdsafsda</div>
              </div>
            </div>
          </Draggable>
        </div>
